...
<div class="detail-container">
    ...
    <aside class="detail-sidebar">
        ...
        <div class="sb-item">
            <a href="#">Chó nhỏ nên ăn gì? Tiêu chí chọn thức ăn đầy đủ dinh dưỡng và phù hợp</a>
            <span>14 November 2025</span>
        </div>

        <div class="sb-item">
            <a href="#">Áo mưa cho chó có thật sự cần? Cách chọn nhanh gọn!</a>
            <span>12 November 2025</span>
        </div>

        <div class="sb-item">
            <a href="#">Thức ăn hạt cho mèo nhạy cảm, ít gây dị ứng</a>
            <span>10 November 2025</span>
        </div>

        <h4 class="premium-title">PREMIUM PET FOOD</h4>
        <div class="line"></div>
    </aside>
    ...
    <div class="detail-main">
        ...
        <div class="breadcrumb-detail">
            ...
            <a href="Blog.jsp">Kiến Thức Chăm Sóc Thú Cưng</a> >
            <span>Chó Nhỏ Nên Ăn Gì?</span>
        </div>

        <!-- TIÊU ĐỀ -->
        <h1>Chó Nhỏ Nên Ăn Gì? Tiêu Chí Chọn Thức Ăn Đầy Đủ Dinh Dưỡng và Phù Hợp</h1>
        ...
        <!-- MỤC LỤC -->
        <h2 class="toc-title">Chuyên mục:</h2>
        <ul class="toc-list">
            <li>1. Chó nhỏ cần những dưỡng chất gì để phát triển khỏe mạnh?</li>
            <li>2. Tiêu chí cần lưu ý khi chọn thức ăn cho chó nhỏ</li>
            <li>3. Gợi ý một số dòng thức ăn phù hợp cho chó nhỏ</li>
            <li>4. Những sai lầm thường gặp khi chọn thức ăn cho chó nhỏ</li>
        </ul>

        <!-- NỘI DUNG BÀI VIẾT (COPY Y HỆT BÊN PADDY) -->
        <div class="post-content">

            <p>Nuôi chó nhỏ là niềm vui lớn với nhiều người yêu thú cưng. Tuy nhiên, việc chọn thức ăn cho chó nhỏ luôn khiến các chủ nuôi băn khoăn...</p>

            <h2>Chó nhỏ cần những dưỡng chất gì để phát triển khỏe mạnh?</h2>
            <p>Trong giai đoạn từ 1 tháng đến 6 tháng tuổi, đang ở thời kỳ phát triển nhanh chóng về cả thể chất lẫn trí não. Vì vậy, chế độ dinh dưỡng dành cho chúng cần phải thật sự đặc biệt và đầy đủ. Việc cung cấp đủ các dưỡng chất thiết yếu không chỉ giúp chó con phát triển khỏe mạnh mà còn góp phần tăng cường hệ miễn dịch, giúp chó chống lại bệnh tật hiệu quả. Dưới đây là các nhóm dưỡng chất quan trọng mà chó nhỏ cần được bổ sung hàng ngày:</p>

            <h2>Protein giúp phát triển cơ bắp và tăng trưởng toàn diện</h2>
            <p>Protein là dưỡng chất thiết yếu cho quá trình xây dựng cơ bắp...</p>

            <h2>Chất béo cung cấp năng lượng và hỗ trợ hấp thụ vitamin</h2>
            <p>Chất béo là nguồn năng lượng chính giúp chó nhỏ hoạt động cả ngày...</p>

            <h2>Tiêu chí cần lưu ý khi chọn thức ăn cho chó nhỏ</h2>
            <p>Khi lựa chọn thức ăn, chủ nuôi cần xem xét kỹ...</p>

            <h2>Những sai lầm phổ biến khi chọn thức ăn</h2>
            <p>Nhiều người thường chọn thức ăn theo cảm tính...</p>
